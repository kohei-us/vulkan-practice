...
#define GLM_FORCE_DEPTH_ZERO_TO_ONE  // use depth range of 0 to 1 instead of -1 to 1.
#include <glm/glm.hpp>
...
private:
    ...
    void createDescriptorSets()
    {
        ...
        // NB: no need to destroy the descriptor sets as they get destroyed when
        // the pool gets destroyed.
    ...
    void createTextureImage()
    {
        ...
        cout << "Texture image:" << endl;
        cout << "  - width: " << texWidth << endl;
        cout << "  - height: " << texHeight << endl;
        cout << "  - channels: " << texChannels << endl;
        cout << "  - mip levels: " << textureMipLevels << endl;
        ...
        createImage(
            texWidth, texHeight, textureMipLevels, VK_SAMPLE_COUNT_1_BIT,
        ...
        uint32_t mipLevels)
    {
        ...
        {
            cout << "Generating mipmap image for level " << i << endl;
            ...
            // Wait until the previous mip level is finished.
    ...
    void createTextureImageView()
    {
        textureImageView = createImageView(
            textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, textureMipLevels);
    }
    ...
    /**
     * Submit a one-time use command buffer and destroy the buffer afterward.
     */
    ...
    void createCommandBuffers()
    {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++)
        {
            ...
            // NB: order of clear values should be identical to the order of attachments.
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        float eye_dist = 6.0f * std::sin(time * 0.6f) + 6.0f;

        UniformBufferObject ubo{};
        ubo.model = glm::rotate(glm::mat4(1.0f), time * glm::radians(60.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = glm::lookAt(glm::vec3(eye_dist, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
